...
load ../spindown/spindown_noRotor_jun1_after % PARASITIC LOSSES
...
% end
rpm = circshift(rpm, -24);
rpm(end-24:end) = rpm(end-24);
rpm = 1./smooth(1./rpm, 48);
...
ylim([0,100]*(-1*isRegen)); ylabel('Power (W)'); xlabel('RPM of motor');
legend show;
grid on;
