...
%filenames = sprintfc('../olgaRaceSim.TXT',0);
%filenames = sprintfc('../patrickFlying.TXT',0);
%filenames = sprintfc('../olga2laps.TXT',0);
filenames = sprintfc('../olgaDark3laps.TXT',0);
%filenames = sprintfc('../olga3lapsRace.TXT',0);
...
%data = data(2000:12100, :); %olga3lapsRace
%data = data(11580:33630, :); %olgaRaceSim
%data = data(1:length(data)/2, :);
%data = data(1834:4862, :); %patrickFlying, 90 psi
%data = data(3900:6900, :); %olga2laps
data = data(42150+1139:42150 + 6934 + 50, :); %olgaDark3Laps
%data = data(2420:12100, :); %olga3LapsRaceSim
