...
static const double CURRENT_OFF_STORE [] = {0,    0.001551,   0.005675,      0}; // offset in A
static const double VOLTAGE_CAL_STORE [] = {1,    1.005079,   0.999573,      0}; // voltage scaling factor
static const double VOLTAGE_OFF_STORE [] = {0,    -0.025144,  0.000210,      0}; // offset voltage in V
...
void INAinit()
{
  uint16_t confReg = ((0100) << 12) | // junk unused
                     ...
                     ((000) << 3) |   // current conversion time (2.116ms)
